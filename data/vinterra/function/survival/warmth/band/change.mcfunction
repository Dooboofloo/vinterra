...
execute if score @s vin.warmth_band > @s vin.warmth_tmp run function vinterra:feedback/warmth/band/colder
execute if score @s vin.warmth_band < @s vin.warmth_tmp run function vinterra:feedback/warmth/band/warmer
