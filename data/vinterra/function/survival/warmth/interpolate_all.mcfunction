...
execute as @a[predicate=vinterra:player/participating] run function vinterra:survival/warmth/interpolate

execute as @a[predicate=vinterra:player/participating] run function vinterra:survival/warmth/band/update
