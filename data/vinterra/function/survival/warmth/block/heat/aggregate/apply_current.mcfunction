...
scoreboard players operation #agg_value vin.warmth_tmp = @e[type=marker,tag=vin.heat_probe_aggregate_current,sort=nearest,limit=1] vin.heat_val

# Diminishing returns by rank
execute if score #agg_rank vin.warmth_tmp matches 2 run scoreboard players operation #agg_value vin.warmth_tmp /= #2 vin.warmth_meta
execute if score #agg_rank vin.warmth_tmp matches 3 run scoreboard players operation #agg_value vin.warmth_tmp /= #4 vin.warmth_meta
...
scoreboard players add #agg_rank vin.warmth_tmp 1
