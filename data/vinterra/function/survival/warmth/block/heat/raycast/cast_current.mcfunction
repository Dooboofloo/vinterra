...
return run execute positioned ~ ~1.0 ~ facing entity @e[type=marker,tag=vin.heat_probe_current,sort=nearest,limit=1] feet positioned ^ ^ ^0.125 run function vinterra:survival/warmth/block/heat/raycast/step