...
# Debug
execute if entity @a[tag=vin.debug_viewer] align xyz positioned ~0.5 ~0.5 ~0.5 run summon block_display ~ ~ ~ {Glowing:1b,Tags:["vin.comfort_debug"],glow_color_override:16758528,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.0625f,-0.0625f,-0.0625f],scale:[0.125f,0.125f,0.125f]},block_state:{Name:"minecraft:orange_wool"}}
