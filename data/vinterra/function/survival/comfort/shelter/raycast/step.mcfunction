...
execute if entity @s[tag=vin.debug_viewer] unless block ~ ~ ~ #vinterra:shelter_passable run summon block_display ~ ~ ~ {Glowing:1b,Tags:["vin.test"],glow_color_override:65280,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.125f,-0.125f,-0.125f],scale:[0.25f,0.25f,0.25f]},block_state:{Name:"minecraft:lantern"}}
