...
# vin.feedback_tmp contains the quantized exposure value from 0-10
...
execute if score @s vin.cold_exposure >= #exposure_target_freezing vin.warmth_meta run data modify storage vinterra:feedback hud.exposure_10 set value "■"
