...
execute as @a[tag=vin.debug_viewer] run title @s actionbar [{text:"W: "},{score:{name:"@s",objective:"vin.warmth_effective"}},{text:" ➡ "},{score:{name:"@s",objective:"vin.warmth_target"}},{text:" | AM: "},{score:{name:"@s",objective:"vin.warmth_ambient"}},{text:" | C:"},{score:{name:"@s",objective:"vin.debug_covered"}},{text:" | WB: "},{score:{name:"@s",objective:"vin.warmth_band"}},{text:" | CE: "},{score:{name:"@s",objective:"vin.cold_exposure"}},{text:" ("},{score:{name:"@s",objective:"vin.cold_stage"}},{text:")"}]